<?php
// Vérifie si $task est défini, sinon initialise avec des valeurs par défaut
if (!isset($task)) {
    $task = ['id_task' => '', 'name_task' => '', 'details_task' => '', 'important_task' => 0, 'repeat_task' => 0, 'end_time_task' => ''];
}
?>
